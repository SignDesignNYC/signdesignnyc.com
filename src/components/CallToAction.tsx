...
export default function CallToAction(): React.ReactNode {
  return (
    <section className="mt-8 px-4 w-full grid md:grow md:mt-0">
      <div className="place-self-center grid gap-8 w-full max-w-sm sm:max-w-lg md:max-w-2xl lg:max-w-4xl lg:grid-cols-2">
        <div className="flex flex-col gap-8">
          ...
          <a
            ...
            target="_blank"
            className="grid place-items-center rounded-full p-2 bg-yellow-400 hover:cursor-pointer md:w-96"
          >
